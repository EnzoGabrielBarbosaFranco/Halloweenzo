  ...
  <footer>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-28">
      <div>
        <div class="flex gap-2 mb-5">
          <h1 class="text-white font-bold text-2xl">Hallow<span class="text-secondary">ee</span>nzo</h1>
        ...
        <p class="text-white leading-loose tracking-wide w-full md:w-[80%]">Site desenvolvido com Vue + Vite + Tailwind.
        </p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-center gap-12 text-white">
        <div>
          <h3 class="mb-4 font-bold text-2xl md:text-lg">Sobre</h3>
          <div class="flex flex-col gap-3">
            <a href="#" class="hover:underline">Sobre Nós</a>
            <a href="#" class="hover:underline">Recursos</a>
            <a href="#" class="hover:underline">Carreira</a>
          </div>
        </div>
        <div>
          <h3 class="mb-4 font-bold text-2xl md:text-lg">Empresa</h3>
          <div class="flex flex-col gap-3">
            <a href="#" class="hover:underline">Meu Time</a>
            <a href="#" class="hover:underline">Parceiros</a>
            <a href="#" class="hover:underline">Perguntas</a>
          </div>
        </div>
        <div>
          <h3 class="mb-4 font-bold text-2xl md:text-lg">Serviços</h3>
          <div class="flex flex-col gap-3">
    ...
    <div class="grid place-items-center my-20 w-full ">
      ...
      <p class="md:text-lg font-medium text-center text-white mt-8 tracking-wider">
        &copy; Copyright, Halloweenzo 2023, All rights reserved.
      </p>
    </div>
</footer></template>